...
const NavBar = (props) => {
  ...
  return (
    <div className='nav'>
        <Link to="/instagram-clone/"><img src="https://www.instagram.com/static/images/web/mobile_nav_type_logo.png/735145cfe0a4.png" alt="logo" /></Link>
        ...
        <div className="nav__menu">
            ...
            <img className='profile_pic' src="https://www.showflipper.com/blog/images/default.jpg" alt="profile-pic" />
        </div>
    </div>
  )
}
